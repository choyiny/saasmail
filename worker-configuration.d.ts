/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 39288f3549215b8fa5afb495a78b8e0d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		EMAIL_QUEUE: Queue;
		ASSETS: Fetcher;
		BASE_URL: "https://mail.vrooman.email";
		TRUSTED_ORIGINS: "https://mail.vrooman.email";
		APP_NAME: "vrooman.email";
		APP_LOGO_LETTER: "v";
		COOKIE_PREFIX: "saasmail";
		RESEND_API_KEY: string;
		BETTER_AUTH_SECRET: string;
		DISABLE_PASSKEY_GATE: string;
		DEMO_MODE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "TRUSTED_ORIGINS" | "APP_NAME" | "APP_LOGO_LETTER" | "COOKIE_PREFIX" | "RESEND_API_KEY" | "BETTER_AUTH_SECRET" | "DISABLE_PASSKEY_GATE" | "DEMO_MODE">> {}
}
